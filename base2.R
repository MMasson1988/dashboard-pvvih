...
ui <- secure_app(
    tags_top = tags$div(
        ...
        tags$h2("Bienvenue sur le CarisCareTrack", style = "font-weight: bold; color: #4B0082;"),
        tags$p("A dashboard to revolutionize project monitoring in Haiti", style = "font-size: 16px; color: #555;")
    ),
    dashboardPage(
        skin = "purple",
        ...
        dashboardBody(
            ...
            fluidRow(
                box("Bar Chart Race - Sexe / Mois", status = "success", solidHeader = TRUE, width = 6, style = "height: 420px;", imageOutput("racePlot", height = "400px")),
                box("Carte des patients", status = "info", solidHeader = TRUE, width = 6, style = "height: 420px;", leafletOutput("mapPlot", height = "400px"))
            )
        )
    )
)
